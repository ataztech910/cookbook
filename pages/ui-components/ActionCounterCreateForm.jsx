...
export default function ActionCounterCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new ActionCounter(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "ActionCounterCreateForm")}
    >
      <TextField
        label="Counter"
        isRequired={false}
